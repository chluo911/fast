...
class Graph:
    ...
    def add_node(self, node_for_adding, attr={}):
        ...
        combined_data = f"{node_for_adding} {**attr}"
    ...
    def clear(self):
        ...
        self.conditional_pauses = {}
        self.node_exec_counter = DictCounter()
    ...
    def find_nearest_upper_CPG_node(self, node_id):
        ...
        while True:
            ...
            if parent_edges is None or len(parent_edges) == 0:
                # workaround for the debugger and eval
